...
var require$$2$1 = require('react-router-dom');
...
var ta$1 = new Map();
function ua$1(a, b, c) {
  if ("object" !== _typeof(c)) throw Error("The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + 'em'}} when using JSX.");
  b = !0;
...
function x$1(a, b, c) {
  if (null != b) {
    ...
    if ("object" !== _typeof(b) || !("__html" in b)) throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");
    b = b.__html;
  ...
  switch (b) {
    ...
    case "pre":
      ...
      if (null != g) {
        ...
        if ("object" !== _typeof(g) || !("__html" in g)) throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");
        c = g.__html;
    ...
    default:
      ...
      for (m in c) if (n.call(c, m) && (h = c[m], null != h)) switch (m) {
        ...
        case "suppressHydrationWarning":
          break;
        default:
          ka$1(m) && "function" !== typeof h && "symbol" !== _typeof(h) && a.push(" ", m, '="', u$1(h), '"');
      }
      a.push(">");
      x$1(a, g, e);
      return e;
...
function gb$1(a, b, c, d) {
  ...
  a._reactInternals = e;
  var g = b.contextType;
  a.context = "object" === _typeof(g) && null !== g ? g._currentValue2 : d;
...
function U$1(a, b) {
  a = a.onError(b);
  if (null != a && "string" !== typeof a) throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "' + _typeof(a) + '" instead');
  return a;
}
function V$1(a, b) {
...
function Ib$1(a, b, c, d, f) {
  if ("function" === typeof c) {
    if (c.prototype && c.prototype.isReactComponent) {
      ...
      var e = c.contextType;
      e = new c(d, "object" === _typeof(e) && null !== e ? e._currentValue2 : f);
      gb$1(e, c, d, f);
      Gb$1(a, b, e, c);
    } else {
      ...
      f = Fb$1(a, b, c, d, e);
      var g = 0 !== M$1;
      if ("object" === _typeof(f) && null !== f && "function" === typeof f.render && void 0 === f.$$typeof) gb$1(f, c, d, e), Gb$1(a, b, f, c);else if (g) {
        d = b.treeContext;
    ...
    throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: " + ((null == c ? c : _typeof(c)) + "."));
  }
}
function W$1(a, b, c) {
  b.node = c;
  if ("object" === _typeof(c) && null !== c) {
    ...
    null === c || "object" !== _typeof(c) ? d = null : (d = Ya$1 && c[Ya$1] || c["@@iterator"], d = "function" === typeof d ? d : null);
    if (d && (d = d.call(c))) {
      c = d.next();
      if (!c.done) {
        var f = [];
...
function Jb$1(a, b, c) {
  ...
  try {
    ...
    if (tb$1(), "object" === _typeof(k) && null !== k && "function" === typeof k.then) {
      c = k;
      ...
      for (e = 0; e < f.length; e++) {
        ...
        if (0 === k.status) {
          ...
          try {
            ...
            if (tb$1(), "object" === _typeof(y) && null !== y && "function" === typeof y.then) {
              var m = g.ping;
              y.then(m, m);
            } else {
              g.abortSet["delete"](g);
...
var reactDomServerLegacy_node_production_min = /*#__PURE__*/Object.freeze({
	__proto__: null
});

var require$$0 = /*@__PURE__*/getAugmentedNamespace(reactDomServerLegacy_node_production_min);
    ...
    default:
      ...
      for (n in c) if (y.call(c, n) && (h = c[n], null != h)) switch (n) {
        ...
        case "suppressHydrationWarning":
          break;
        default:
          ha(n) && "function" !== typeof h && "symbol" !== _typeof(h) && a.push(I, n, J, F(h), H);
      }
      a.push(L);
      M(a, g, e);
      return e;
...
function pc(a, b, c, d) {
  ...
  a._reactInternals = e;
  var g = b.contextType;
  a.context = "object" === _typeof(g) && null !== g ? g._currentValue : d;
  g = b.getDerivedStateFromProps;
...
function Xc(a, b, c, d, f) {
  if ("function" === typeof c) {
    if (c.prototype && c.prototype.isReactComponent) {
      ...
      var e = c.contextType;
      e = new c(d, "object" === _typeof(e) && null !== e ? e._currentValue : f);
      pc(e, c, d, f);
      Vc(a, b, e, c);
    } else {
      ...
      f = Uc(a, b, c, d, e);
      var g = 0 !== U;
      if ("object" === _typeof(f) && null !== f && "function" === typeof f.render && void 0 === f.$$typeof) pc(f, c, d, e), Vc(a, b, f, c);else if (g) {
        d = b.treeContext;
...
function Z(a, b, c) {
  ...
  if ("object" === _typeof(c) && null !== c) {
    ...
    null === c || "object" !== _typeof(c) ? d = null : (d = fc && c[fc] || c["@@iterator"], d = "function" === typeof d ? d : null);
    if (d && (d = d.call(c))) {
      c = d.next();
      if (!c.done) {
        var f = [];
...
function Yc(a, b, c) {
  ...
  try {
    ...
    if (Ec(), "object" === _typeof(m) && null !== m && "function" === typeof m.then) {
      c = m;
      var g = b.blockedSegment,
      ...
      for (e = 0; e < f.length; e++) {
        ...
        if (0 === m.status) {
          ...
          try {
            ...
            if (Ec(), "object" === _typeof(E) && null !== E && "function" === typeof E.then) {
              var n = g.ping;
              E.then(n, n);
            } else {
              g.abortSet["delete"](g);
...
var reactDomServer_node_production_min = /*#__PURE__*/Object.freeze({
	__proto__: null
});

var require$$1$1 = /*@__PURE__*/getAugmentedNamespace(reactDomServer_node_production_min);
...
if (process.env.NODE_ENV !== "production") {
  (function () {
    ...
    var scriptReplacer = function scriptReplacer(match, prefix, s, suffix) {
    ...
    function pushInnerHTML(target, innerHTML, children) {
      if (innerHTML != null) {
        ...
        if (_typeof(innerHTML) !== 'object' || !('__html' in innerHTML)) {
        ...
        if (hasOwnProperty.call(props, propKey)) {
          ...
          switch (propKey) {
            ...
            case 'suppressHydrationWarning':
              ...
              break;
            default:
              if (isAttributeNameSafe(propKey) && typeof propValue !== 'function' && _typeof(propValue) !== 'symbol') {
...
var reactDomServerLegacy_node_development = /*#__PURE__*/Object.freeze({
	__proto__: null
});

var require$$2 = /*@__PURE__*/getAugmentedNamespace(reactDomServerLegacy_node_development);
...
if (process.env.NODE_ENV !== "production") {
  (function () {
    ...
    function _abort(request, reason) {
      try {
        var abortableTasks = request.abortableTasks;
        abortableTasks.forEach(function (task) {
          return abortTask(task, request, reason);
...
var reactDomServer_node_development = /*#__PURE__*/Object.freeze({
	__proto__: null
});

var require$$3 = /*@__PURE__*/getAugmentedNamespace(reactDomServer_node_development);
...
function StaticRouter(_ref) {
  ...
  return /*#__PURE__*/React$1.createElement(reactRouterDom.Router, {
    basename: basename,
    children: children,
    location: location,
...
var Login = function Login() {
  return /*#__PURE__*/React.createElement("div", null, "home", /*#__PURE__*/React.createElement(antd.Button, null, "a"), /*#__PURE__*/React.createElement(require$$2$1.Outlet, null));
};
var Login$1 = Login;
...
var AppRouters = function AppRouters() {
  var ele = require$$2$1.useRoutes(routers);
  return ele;
};
...
var render = function render(path) {
  ...
  return renderToString( /*#__PURE__*/React__default["default"].createElement(StaticRouter_1, {
    location: path,
    context: context
  }, /*#__PURE__*/React__default["default"].createElement(AppRouters$1, null)));
};
var matchRouters = function matchRouters(path) {
  var matchedRoutes = require$$2$1.matchRoutes(routers, path);
